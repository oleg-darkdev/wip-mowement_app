<script lang="ts">
	...
	let { firstName, lastName, shortDesc, photo, wikiLink, birthDate, deathDate, desc, index } =
		$props();
			...
			<div class="riot-list_link-block-content mr-4 w-4/12">
				<div class="margin-bottom margin-xxsmall">
					<h4 class="riot-list_link-text">
						<span class="mr-4"><em>{index + 1}.</em></span>{firstName}
						{lastName}
					</h4>
				</div>
		...
		<div class="">
			{#if photo}
				<div class=" pointer-events-off max-w-sm">
					<img src={photo} loading="lazy" alt="" class="grayscale-[70] object-cover h-40 w-40" />
				</div>
			{/if}
